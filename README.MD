...
#### Using the Rakefile
You will need:
 - [flexspin/fastspin](https://github.com/totalspectrum/spin2cpp/releases) 4.3.0 or 5.0.0. (~~Current version has regressions preventing it from building~~ Should be fine again)
